...
def portfolio_markdown(
    ...
    lines = [
        ...
        "- Context evaluation set is checked in under "
        "`docs/reports/waymo_context_eval_set.md`.",
        "- Context eval debug casebook is checked in under "
        "`docs/reports/waymo_context_eval_debug_casebook.md`.",
        "- Context replay candidate plan is checked in under "
        ...
        "- Lane-link continuation prototype is checked in under "
        "`docs/reports/waymo_lane_continuation_prototype.md`.",
        "- Lane-continuation validation study is checked in under "
        "`docs/reports/waymo_lane_continuation_study.md`.",
        "- Lane-continuation candidate plan is checked in under "
        "`docs/reports/waymo_lane_continuation_candidate_plan.md`.",
        "- Lane-continuation replay prototype is checked in under "
        "`docs/reports/waymo_lane_continuation_replay_prototype.md`.",
        "- Lane-continuation route diagnostics are checked in under "
        "`docs/reports/waymo_lane_continuation_route_diagnostics.md`.",
        "- Lane-continuation branch-selection diagnostics are checked in under "
        "`docs/reports/waymo_lane_continuation_branch_selection.md`.",
        "- Motion-context branch replay diagnostics are checked in under "
        ...
        "- Expanded branch coverage audit is checked in under "
        ...
        "- Expanded terminal-neighborhood selector calibration is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_calibration_expanded.md`.",
        "- 200-scenario terminal-neighborhood selector transfer validation is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_transfer_200.md`.",
        "- 200-scenario terminal-neighborhood selector error audit is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_error_audit_200.md`.",
        "- 200-scenario terminal-neighborhood selector route/context audit is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_route_context_audit_200.md`.",
        "- 200-scenario terminal-neighborhood selector candidate validation is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_candidate_validation_200.md`.",
        "- 200-scenario terminal-neighborhood selector decision atlas is checked in under "
        ...
        "- Terminal-neighborhood replay gate is checked in under "
        "`docs/reports/waymo_lane_continuation_terminal_neighborhood_replay.md`.",
        "- Terminal-neighborhood selector experiment is checked in under "
        ...
        "- Heading-aware replay prototype is checked in under "
