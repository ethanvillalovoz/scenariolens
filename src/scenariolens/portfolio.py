...
def portfolio_markdown(
    ...
    lines.extend(
        [
            ...
            "- Turn the accepted terminal-neighborhood replay candidate into a bounded selector experiment.",
