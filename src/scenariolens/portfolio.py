...
def portfolio_markdown(
    ...
    lines.extend(
        [
            ...
            "- The lane-link continuation prototype, validation study, candidate plan, replay prototype, route diagnostics, branch-selection diagnostic, and branch replay are topology diagnostic evidence, not route planning.",
            ...
            "- Add richer route context for gain-sensitive branch replay cases.",
