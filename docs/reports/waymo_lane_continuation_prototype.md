...
| Evaluated cases | 1 |
| Evaluated tracks | 1 |
| Tracks using linked lanes | 0 |
| Tracks improved over nearest lane | 0 |
| Tracks still clamped after links | 1 |
| Mean nearest FDE | 110.266 m |
| Mean lane-link FDE | 110.266 m |
| Mean lane-link improvement over nearest | 0.000 m |

## Case Summary

| Rank | Scenario | Tracks | CV FDE | Nearest FDE | Heading FDE | Lane-link FDE | Link improvement | Main result |
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | `ef4c5d0e40fdea48` | 1 | 46.688 m | 110.266 m | 110.266 m | 110.266 m | 0.000 m | `topology_gap` |

## `ef4c5d0e40fdea48`

- Case: Context eval seed 5
- Source: `validation.tfrecord-00008-of-00150`
- Primary result: **topology_gap**
- Why: No usable linked lane was available from the selected map feature.
- Recommended next action: Improve parsed lane topology before treating this as a route-link candidate.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `755` | 46.688 m | 110.266 m | 110.266 m | 110.266 m | 0.000 m | 144 | 16.691 m / 16.691 m | `topology_gap` |
