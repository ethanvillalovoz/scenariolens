...
- Lane-continuation route diagnostics are checked in under `docs/reports/waymo_lane_continuation_route_diagnostics.md`.
- Lane-continuation branch-selection diagnostics are checked in under `docs/reports/waymo_lane_continuation_branch_selection.md`.
- Motion-context branch replay diagnostics are checked in under `docs/reports/waymo_lane_continuation_branch_replay.md`.
- Branch rollout gate diagnostics are checked in under `docs/reports/waymo_lane_continuation_branch_rollout_gate.md`.
...
- Expanded topology gap audit is checked in under `docs/reports/waymo_lane_continuation_topology_gap_audit_expanded.md`.
- Expanded terminal-neighborhood audit is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_audit_expanded.md`.
- Expanded terminal-neighborhood replay gate is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_replay_expanded.md`.
- Expanded terminal-neighborhood selector experiment is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_expanded.md`.
- Expanded terminal-neighborhood selector calibration is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_calibration_expanded.md`.
- 200-scenario terminal-neighborhood selector transfer validation is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_transfer_200.md`.
- 200-scenario terminal-neighborhood selector error audit is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_error_audit_200.md`.
- 200-scenario terminal-neighborhood selector route/context audit is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_route_context_audit_200.md`.
- 200-scenario terminal-neighborhood selector candidate validation is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_candidate_validation_200.md`.
- 200-scenario terminal-neighborhood selector decision atlas is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector_decision_atlas_200.md`.
...
- Terminal-neighborhood selector experiment is checked in under `docs/reports/waymo_lane_continuation_terminal_neighborhood_selector.md`.
...
- Broaden the calibrated terminal-neighborhood selector queue across more candidates.
