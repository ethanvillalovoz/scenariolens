...
9. Report, portfolio, renderer, and dashboard exporters.
10. Static Scenario Explorer backed by deterministic JSON and SVG assets.
...
3. Improve map matching with heading, lane coverage, coordinate-frame, and
   route/intent checks.
