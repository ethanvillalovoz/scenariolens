...
| Lane-continuation branch replay | `src/scenariolens/lane_continuation_branch_replay.py` | Replays motion-context branch choices under deterministic anchor perturbations, reporting branch preservation, positive-gain stability, accepted branch cases, and route-context margin follow-ups without route-planning claims. |
