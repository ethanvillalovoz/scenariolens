...
signal to collect more evidence before changing defaults. A follow-up
selector-error audit turns those false holds into gate-level diagnostics: one
borderline heading miss is recoverable by a 0.70 heading candidate on the small
