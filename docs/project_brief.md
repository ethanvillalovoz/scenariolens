...
a lane-link continuation prototype, validation study, candidate plan, and
replay prototype, Markdown/JSON reports, a local real-data validation packet workflow, static dashboard data, and 2D SVG trajectory
