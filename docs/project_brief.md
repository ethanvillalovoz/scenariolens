...
route-context guard calibration, branch coverage, topology gap and
terminal-neighborhood audits, plus a terminal-neighborhood replay gate and
bounded selector experiment,
